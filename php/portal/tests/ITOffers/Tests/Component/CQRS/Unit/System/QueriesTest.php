...
use ITOffers\Tests\Offers\Application\Double\Dummy\DummyQuery;
use ITOffers\Tests\Offers\Application\Double\Fake\FakeQueryInterface;
...
final class QueriesTest extends TestCase
{
    ...
    {
        $this->expectException(Exception::class);
        $this->expectExceptionMessage('Query "\DateTime" does not exists. Available Query: "\ITOffers\Tests\Offers\Application\Double\Dummy\DummyQuery"');
