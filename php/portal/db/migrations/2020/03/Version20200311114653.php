...
final class Version20200311114653 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE itof_job_offer (id UUID NOT NULL, email_hash VARCHAR(255) NOT NULL, user_id UUID NOT NULL, specialization_id UUID NOT NULL, created_at TIMESTAMP(6) WITHOUT TIME ZONE NOT NULL, salary JSON DEFAULT NULL, removed_at TIMESTAMP(6) WITHOUT TIME ZONE DEFAULT NULL, locale_code VARCHAR(12) NOT NULL, company_name VARCHAR(255) NOT NULL, company_url VARCHAR(2083) NOT NULL, company_description VARCHAR(512) NOT NULL, position_seniority_level SMALLINT NOT NULL, position_name VARCHAR(255) NOT NULL, location_remote BOOLEAN NOT NULL, location_country_code VARCHAR(2) DEFAULT NULL, location_city VARCHAR(512) DEFAULT NULL, location_address VARCHAR(2048) DEFAULT NULL, location_lat DOUBLE PRECISION DEFAULT NULL, location_lng DOUBLE PRECISION DEFAULT NULL, contract_type VARCHAR(255) NOT NULL, description_technology_stack VARCHAR(2048) NOT NULL, description_benefits VARCHAR(2048) NOT NULL, description_requirements_description VARCHAR(2048) NOT NULL, description_requirements_skills JSON NOT NULL, contact_email VARCHAR(255) NOT NULL, contact_name VARCHAR(255) NOT NULL, contact_phone VARCHAR(16) DEFAULT NULL, PRIMARY KEY(id))');
