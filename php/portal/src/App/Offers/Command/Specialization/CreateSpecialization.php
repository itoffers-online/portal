...
use ITOffers\Offers\Application\Command\Specialization\CreateSpecialization as SystemCreateSpecializationCommand;
...
final class CreateSpecialization extends Command
{
    ...
    protected function configure() : void
    {
        $this
            ...
            ->addArgument('facebook_group_name', InputArgument::OPTIONAL, 'Facebook group name where page will post offers')
        ;
    }
